...
5. After deploy, copy your Render URL (e.g. https://pydebugger-backend.onrender.com)
...
4. Add environment variable:
   - Key: VITE_API_URL
   - Value: https://pydebugger-backend.onrender.com  ← your Render URL
5. Deploy

### After Both Are Deployed
Update backend ALLOWED_ORIGINS on Render:
- Go to Render dashboard → your service → Environment
- Set ALLOWED_ORIGINS to your Vercel URL (e.g. https://pydebugger.vercel.app)
